...
<div id="page" class="l-page">
  ...
  <header class="l-header" role="banner">
    <div class="l-header-inner container">
      <?php if ($logo): ?>
        <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>" rel="home" class="header__logo logo">
  ...
  <main id="main" class="l-main container" role="main">

    <?php if ($breadcrumb): ?>
      <div id="breadcrumb" class="breadcrumb__wrapper"><?php print $breadcrumb; ?></div>
    <?php endif; ?>
    ...
    <?php if ($title): ?>
      <h1 class="l-page-title"><?php print $title; ?></h1>
    <?php endif; ?>
